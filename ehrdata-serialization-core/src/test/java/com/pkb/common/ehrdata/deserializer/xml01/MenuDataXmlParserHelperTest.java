...
public class MenuDataXmlParserHelperTest {
    ...
    public void testDiagnosisCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(DIAGNOSIS.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testAllergyCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(ALLERGY.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testSymptomCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(SYMPTOM.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testMeasurementCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(MEASUREMENT.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testTestResultCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(TEST.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testMessageCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(MESSAGE.getBytes(), new NoOpAutocloseableTimer());
    ...
    public void testAppointmentCanBeParsed() {
        ...
        // WHEN
        Map<String, Object> actual = MenuDataXmlParserHelper.unmarshalEncryptedFields(APPOINTMENT.getBytes(), new NoOpAutocloseableTimer());
