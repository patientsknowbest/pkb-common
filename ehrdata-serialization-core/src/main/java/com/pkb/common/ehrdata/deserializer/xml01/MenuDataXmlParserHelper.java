...
public class MenuDataXmlParserHelper {
    ...
    @NotNull
    public static Map<String, Object> unmarshalEncryptedFields(byte[] plaintext, AutocloseableTimer parseTimer) {

        if (ArrayUtils.isNotEmpty(plaintext)) {
            return unchecked(() -> {
                XMLStreamReader reader = null;
                try (AutocloseableTimer ignored = parseTimer.startTimer()) {
