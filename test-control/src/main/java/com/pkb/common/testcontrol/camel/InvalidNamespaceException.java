package com.pkb.common.testcontrol.camel;

/**
 * Camel provides Exception-specific exception handlers.
 * We may want different behaviour for Namespace issues compared with e.g. DB issues
 */
public class InvalidNamespaceException extends RuntimeException {

    private static final long serialVersionUID = 4817274701777148140L;
